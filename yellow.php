...
<html lang="en">
	<head>
		...
		<title>New Music North Dakota</title>
		...
		<link href="css/styles-yellow.css" rel="stylesheet" />
	</head>
	<body id="page-top">
		<!-- Navigation-->
		<nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
			<a class="navbar-brand js-scroll-trigger" href="#page-top">
				<span class="d-block d-lg-none">New Music North Dakota</span>
				<span class="d-none d-lg-block"><img class="img-fluid mx-auto mb-2" src="NMND-web.png" alt="..." /></span>
			</a>
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav">
					...
					<li class="nav-item"><a class="nav-link js-scroll-trigger" href="#duo">Duo</a></li>
		...
		<div class="container-fluid p-0">
			...
			<section class="resume-section" id="about">
				<div class="resume-section-content">
					<h1 class="mb-0">New Music North Dakota</h1>
			...
			<!-- Duo-->
			<section class="resume-section" id="duo">
				<div class="resume-section-content">
					<h2 class="mb-5">Duo</h2>
					<div class="d-flex flex-column flex-md-row justify-content-between mb-5">
						<div class="flex-grow-1">
